        ...
        stage('Setup') {
            steps {
                script {
                    ...
                    env.WORKSPACE_PATH = "/home/jenkins/agent/workspace/roundcube-ispconfig"
                    env.CHART_PATH = "${env.WORKSPACE_PATH}/helm/roundcube-ispconfig"
                    env.PKG_PATH = "${env.WORKSPACE_PATH}/helm/packages"
                }
